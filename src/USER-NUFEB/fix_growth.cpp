...
void FixGrowth::update_atoms_bacillus(AtomVecBacillus *&avec)
{
  ...
  for (int i = 0; i < atom->nlocal; i++) {
    if (atom->mask[i] & groupbit) {
      ...
      //std::cout << "pole1[0] " << pole1[0] << std::endl;
      //std::cout << "pole1[1] " << pole1[1] << std::endl;
      //std::cout << "pole1[2] " << pole1[2] << std::endl;
      //std::cout << "pole2[0] " << pole2[0] << std::endl;
      //std::cout << "pole2[1] " << pole2[1] << std::endl;
      //std::cout << "pole2[2] " << pole2[2] << std::endl;
      ...
      //std::cout << "x coordinate: " << atom->x[i][0] << std::endl;
      //std::cout << "y coordinate: " << atom->x[i][1] << std::endl;
      //std::cout << "z coordinate: " << atom->x[i][2] << std::endl;
      //std::cout << "pole1[0] " << pole1[0] << std::endl;
      //std::cout << "pole1[1] " << pole1[1] << std::endl;
      //std::cout << "pole1[2] " << pole1[2] << std::endl;
      //std::cout << "pole2[0] " << pole2[0] << std::endl;
